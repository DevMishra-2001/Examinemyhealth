...
const WellnessGuide = () => {
  ...
  const FloatingTestButton = () => {
    return (
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50 bg-white shadow-lg px-4 py-2 md:px-6 md:py-3 rounded-full cursor-pointer hover:shadow-xl transition-all"
      >
        <Link
          to={getTestUrl()}
        ...
        >
          ...
          <FaHeartPulse className="text-red-500 w-4 h-4 md:w-5 md:h-5" />
        </Link>
      </motion.div>
    );
  };
  ...
  return (
    <>
      <div className="min-h-screen w-full bg-white">
        <div className="mx-auto bg-[#e8e7e3] shadow-lg rounded-lg p-4 md:p-8 lg:p-12 overflow-hidden">
          {/* COVID-19/RESPIRATORY SECTION */}
          <div
            id="respiratory"
            ref={(el) => {
            ...
            className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 lg:gap-16 min-h-screen"
          >
            {/* Left column */}
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="">
                ...
                <motion.ul
                  ...
                  transition={{ duration: 0.7, delay: 0.2 }}
                  className="list-disc list-inside space-y-1 md:space-y-2 ml-4 md:ml-8 font-semibold text-sm md:text-base"
                >
                  <li className="marker:text-yellow-400">
                    Persistent dry cough
                  </li>
            ...
            <div className="space-y-8 md:space-y-12 mt-8 md:mt-0">
              ...
              <motion.div
                ...
                transition={{ duration: 0.7 }}
                className="w-full aspect-square rounded-xl md:rounded-3xl overflow-hidden bg-gray-200 relative"
              >
                <img
                  src="/Images/WellnessGuide/12466.jpg"
                  alt="Tea cup and interior"
          ...
          <div className="w-full mt-6 md:mt-10">
            <div className="">
              <motion.h3
                ...
                transition={{ duration: 0.7 }}
                className="text-xl md:text-2xl font-bold mb-2 md:mb-4 p-2 md:p-3"
              >
                Why Early Testing Matters{" "}
              </motion.h3>
            </div>
            <div className="flex flex-col md:flex-row justify-between flex-wrap gap-4 px-2 md:px-4">
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={
                  respiratoryBottomInView
                ...
                className="flex items-center space-x-2"
              >
                <ShieldCheck className="w-6 h-6 md:w-7 md:h-7 text-violet-700" />
              ...
              <motion.div
                ...
                className="flex items-center space-x-2"
              >
                <LuTestTube className="w-8 h-6 md:w-10 md:h-8 text-violet-700" />
                <span className="text-sm md:text-base font-semibold">
                  Access early treatment options
                </span>
              </motion.div>
              <motion.div
                ...
                className="flex items-center space-x-2"
              >
                <IoMdContacts className="w-8 h-6 md:w-10 md:h-8 text-violet-700" />
                <span className="text-sm md:text-base font-semibold">
                  Alert close contacts promptly
                </span>
              </motion.div>
      ...
      >
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="px-4 md:px-0">
            ...
            >
              <SiQuicktime className="text-blue-400" size={"17px"} />
              <h3 className="text-lg font-bold mb-2">Early Phase (Days 1-2)</h3>
            </motion.div>
            <motion.ul
              initial={{ opacity: 0, x: -50, md: { x: -100 } }}
              animate={
        ...
        <div className="space-y-8 md:space-y-12 mt-8 md:mt-0">
          <div className="text-center px-4 md:px-0">
            <motion.h1
              ...
              transition={{ duration: 0.5 }}
              className="text-4xl md:text-5xl font-serif tracking-normal leading-none"
            >
              RSV
            </motion.h1>
            <motion.span
          ...
          <motion.div
            ...
            transition={{ duration: 0.7 }}
            className="w-full aspect-square rounded-3xl overflow-hidden bg-gray-200 relative mx-auto px-4 md:px-0"
          >
            <img
              src="/Images/WellnessGuide/rsv-3.webp"
              alt="Tea cup and interior"
      ...
      <div className="flex justify-between items-center mb-10 md:mb-20 mt-10 md:mt-20 relative">
        <div className="absolute inset-0 flex items-center justify-start top-1 left-10 md:left-40">
          <svg
            width="20px"
            height="20px"
      ...
      >
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="mb-2 px-4 md:px-0">
            ...
            >
              <GiProgression className="h-5 w-5 text-blue-500" />
              <h3 className="text-lg font-bold mb-2">Progressive Symptoms</h3>
            </motion.div>
            <motion.ul
              initial={{ opacity: 0, x: -50, md: { x: -100 } }}
              animate={
        ...
        <div className="space-y-8 md:space-y-12 mt-4 md:mt-0">
          ...
          <div className="px-4 md:px-0">
            ...
            <motion.ul
              ...
              className="list-disc list-inside space-y-2 ml-2 md:ml-8 font-semibold"
            >
              <li className="marker:text-yellow-400">
                Children under 5, especially under 2
              </li>
          ...
          <div className="w-full mt-10">
            ...
            <div className="flex flex-col sm:flex-row justify-between flex-wrap gap-4 px-2 md:px-4">
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={
                  influenzaBottomInView
                ...
                className="flex items-center space-x-2"
              >
                <ShieldCheck className="w-6 h-6 md:w-7 md:h-7 text-violet-700 flex-shrink-0" />
              ...
              <motion.div
                ...
                className="flex items-center space-x-2"
              >
                <LuTestTube className="w-6 h-6 md:w-10 md:h-8 text-violet-700 flex-shrink-0" />
                <span className="font-semibold text-sm md:text-base">
                  Access to effective antiviral treatments
                </span>
              </motion.div>
              <motion.div
                ...
                className="flex items-center space-x-2"
              >
                <IoMdContacts className="w-6 h-6 md:w-10 md:h-8 text-violet-700 flex-shrink-0" />
                <span className="font-semibold text-sm md:text-base">
                  Protect vulnerable family members
                </span>
              </motion.div>
          ...
          {/* DIVIDER */}
          <div className="flex justify-between items-center my-10 md:my-20 relative">
            <div className="absolute inset-0 flex items-center justify-start top-1 left-10 md:left-40">
              <svg
                width="20px"
                height="20px"
            ...
            <div className="space-y-8 md:space-y-12">
              <div className="text-center">
                ...
                <motion.p
                  ...
                  transition={{ duration: 0.7, delay: 0.2 }}
                  className="text-xs md:text-sm px-4 md:px-0"
                >
                  Understanding respiratory conditions, early warning signs, and
                  when to seek professional care.
                </motion.p>
          ...
          <div className="flex justify-between items-center my-10 sm:my-20 relative">
            <div className="absolute hidden sm:flex items-center justify-start top-1 left-8 sm:left-40">
              <svg
                width="25px"
                height="25px"
                viewBox="0 0 16 16"
            ...
            <div className="absolute hidden sm:flex items-center justify-end top-1 right-8 sm:right-40">
              <svg
                width="25px"
                height="25px"
                viewBox="0 0 16 16"
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="px-4 md:px-0">
                <motion.div
                  ...
                  className="flex items-center space-x-2"
                >
                  <FaHandHoldingMedical className="w-5 h-5 text-blue-500" />
                  <h3 className="text-lg font-bold mb-2">
                    Medication Response
                  </h3>
                </motion.div>
          ...
          <div className="w-full mt-10 px-4 md:px-0">
            ...
            <div className="flex flex-col md:flex-row justify-between flex-wrap gap-4 px-4">
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={
                  pharmacogenomicsBottomInView
          ...
          <div className="space-y-8 md:space-y-12">
            <div className="text-center">
              ...
              <motion.p
                ...
                transition={{ duration: 0.6, delay: 0.3 }}
                className="text-xs sm:text-sm px-4 md:px-0"
              >
                Discover how hereditary testing can provide insights into your
                genetic health risks and empower proactive care.
              </motion.p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.3 }}
              className="w-full aspect-square rounded-2xl md:rounded-3xl overflow-hidden bg-gray-200 relative"
            >
              <img
                src="/Images/WellnessGuide/hereditary-2.jpg"
                alt="Tea cup and interior"
          ...
          <div className="w-full mt-6 md:mt-10">
            ...
            >
              <motion.h3
                ...
                transition={{ duration: 0.7 }}
                className="text-xl md:text-2xl font-bold mb-3 md:mb-4 p-2 md:p-3"
              >
                Why Hereditary Testing Matters
              </motion.h3>
            </div>
            <div className="flex flex-col sm:flex-row justify-between flex-wrap gap-3 md:gap-4 px-2 md:px-4">
              <motion.div
                initial={{ opacity: 0, y: 40 }}
                animate={
                  hereditaryBottomInView
