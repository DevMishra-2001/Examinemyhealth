          ...
          >
            <ul className="flex justify-between w-full px-2 md:px-0 md:space-x-6">
              {Object.keys(categoryMap).map((tabName) => (
                <li 
                  key={tabName}
                  className={`text-xs sm:text-sm md:text-base px-2 md:px-8 py-2 cursor-pointer transition-colors rounded-full ${
                    activeCategory === categoryMap[tabName] 
                      ? "bg-white/80 font-medium" 
                      : "text-white hover:bg-white/30"
                  }`}
            ...
            >
              <div className="relative flex justify-center">
                ...
                <div className="bg-transparent py-6 px-4 md:p-8 rounded-lg text-center w-full max-w-4xl mx-6">
                  ...
                  <blockquote className="text-xs sm:text-sm md:text-base leading-relaxed mb-4 md:mb-8 h-auto md:h-20 overflow-hidden">
                    {filteredCards[activeIndex].description}
                  </blockquote>
                  
                  <h3 className="text-base md:text-lg font-semibold mb-4">{filteredCards[activeIndex].title}</h3>
