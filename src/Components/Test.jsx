  ...
  return (
    <>
      <section className="relative py-8 md:py-16 bg-white overflow-hidden">
                    ...
                    <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
                      ...
                      >
                        <img
                          src={service.image}
                          alt={service.title}
                          className="w-full h-40 sm:h-48 md:h-56 object-cover rounded-b-full rounded-t-2xl"
                        />
                      </motion.div>
        ...
        {/* Decorative shapes */}
        <div className="hidden sm:block absolute right-0 md:right-10 bottom-0 animate-slowBounce -z-1">
          <img
            src="/Images/Test/shape-03.png"
            alt="Decorative shape"
        ...
        <div className="hidden sm:block absolute mt-4 md:mt-9 left-0 top-0 transform animate-slowBounce">
          <img
            src="/Images/Test/shape-04.png"
            alt="Decorative shape"
