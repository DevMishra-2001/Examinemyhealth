                  ...
                  <div className="flex items-center justify-start h-full">
                    <div className="w-full sm:w-4/5 md:w-3/4 lg:w-2/3 xl:w-7/12 text-black">
                      ...
                      >
                        <a
                          href="#"
                          className="px-4 sm:px-5 md:px-6 py-2 md:py-3 text-sm md:text-base bg-indigo-700 border-2 border-white text-white font-medium font-title rounded-xl mr-2 sm:mr-4 mb-2 hover:bg-yellow-50 hover:text-blue-500  transition-all"
                        >
                          Read More
                        </a>
                        <a
                          href="#"
                          className="px-4 sm:px-5 md:px-6 py-2 md:py-3 text-sm md:text-base bg-indigo-700 border-2 border-white text-white font-medium font-title rounded-xl mb-2 hover:bg-yellow-50 hover:text-blue-500 transition-all"
                        >
                          Contact Us
                        </a>
                      </div>
